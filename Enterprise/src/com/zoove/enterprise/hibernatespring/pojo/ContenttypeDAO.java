 ...
 * 
 * @see com.zoove.enterprise.hibernatespring.pojo.Contenttype
 * @author MyEclipse Persistence Tools
 */

public class ContenttypeDAO extends HibernateDaoSupport {
	...
	public Contenttype findById(java.lang.Integer id) {
		...
		try {
			Contenttype instance = (Contenttype) getHibernateTemplate()
					.get("com.zoove.enterprise.hibernatespring.pojo.Contenttype",
							id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Contenttype> findByExample(Contenttype instance) {
		...
		try {
			List<Contenttype> results = (List<Contenttype>) getHibernateTemplate()
	...
	public Contenttype merge(Contenttype detachedInstance) {
		...
		try {
			Contenttype result = (Contenttype) getHibernateTemplate().merge(
					detachedInstance);
