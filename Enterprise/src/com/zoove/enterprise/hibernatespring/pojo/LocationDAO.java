 ...
 * 
 * @see com.zoove.enterprise.hibernatespring.pojo.Location
...
public class LocationDAO extends HibernateDaoSupport {
	...
	public static final String LOCATIONPARENTID = "locationparentid";
	...
	public Location findById(java.lang.Integer id) {
		...
		try {
			Location instance = (Location) getHibernateTemplate().get(
					"com.zoove.enterprise.hibernatespring.pojo.Location", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Location> findByExample(Location instance) {
		...
		try {
			List<Location> results = (List<Location>) getHibernateTemplate()
	...
	public List<Location> findByLocationname(Object locationname) {
		return findByProperty(LOCATIONNAME, locationname);
	}

	public List<Location> findByLocationparentid(Object locationparentid) {
		return findByProperty(LOCATIONPARENTID, locationparentid);
	}

	public List<Location> findByHierarchyid(Object hierarchyid) {
		return findByProperty(HIERARCHYID, hierarchyid);
	}
