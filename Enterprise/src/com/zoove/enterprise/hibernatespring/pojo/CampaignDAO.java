 ...
 * 
 * @see com.zoove.enterprise.hibernatespring.pojo.Campaign
...
public class CampaignDAO extends HibernateDaoSupport {
	...
	public Campaign findById(java.lang.Integer id) {
		...
		try {
			Campaign instance = (Campaign) getHibernateTemplate().get(
					"com.zoove.enterprise.hibernatespring.pojo.Campaign", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Campaign> findByExample(Campaign instance) {
		...
		try {
			List<Campaign> results = (List<Campaign>) getHibernateTemplate()
	...
	public List<Campaign> findByName(Object name) {
		return findByProperty(NAME, name);
	}

	public List<Campaign> findByDescription(Object description) {
